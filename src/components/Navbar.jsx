...
import { FaHome, FaInfoCircle, FaEnvelope, FaSignInAlt, FaBars, FaTimes } from 'react-icons/fa';
    ...
    <nav className="bg-gradient-to-r from-blue-900 via-blue-600 to-green-600 p-4 text-white shadow-lg font-poppins">
      <div className="container mx-auto flex justify-between items-center">
        ...
        >
          <Link
            to="/"
            className="flex font-poppins items-center space-x-2 hover:text-yellow-400 transition duration-200"
          >
            <FaHome />
            <span>Home</span>
          </Link>
